...
<div class="right-div">
    <h3>Pay online on this saurav@pay.com</h3>
    <input class="input-style" type="text" name="transactionId"  placeholder="Enter Transaction">
...
<div class="right-div">
    <h3 style="color: red">*If you enter the wrong transaction id then your order can be canceled!</h3>
    <button class="button" type="submit">Proceed to Generate Bill and Save <i class='far fa-arrow-alt-circle-right'></i></button>
    <h3 style="color: red">*Fill out the form correctly</h3>
</div>
</form>
<% } %>
<%
